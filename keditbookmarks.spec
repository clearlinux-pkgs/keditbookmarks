...
Version  : 18.12.2
Release  : 2
URL      : https://download.kde.org/stable/applications/18.12.2/src/keditbookmarks-18.12.2.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.2/src/keditbookmarks-18.12.2.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.2/src/keditbookmarks-18.12.2.tar.xz.sig
...
%prep
%setup -q -n keditbookmarks-18.12.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1549866165
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
cp COPYING.DOC %{buildroot}/usr/share/package-licenses/keditbookmarks/COPYING.DOC
pushd clr-build
%make_install
popd
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/keditbookmarks/COPYING
/usr/share/package-licenses/keditbookmarks/COPYING.DOC
