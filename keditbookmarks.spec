...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/keditbookmarks-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/keditbookmarks-24.12.3.tar.xz.sig
Source2  : BB463350D6EF31EF.pkey
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-2-Clause BSD-3-Clause CC0-1.0 GFDL-1.2 GPL-2.0 GPL-3.0 LGPL-2.0
...
%setup -q -n keditbookmarks-24.12.3
cd %{_builddir}/keditbookmarks-24.12.3
pushd ..
cp -a keditbookmarks-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742494576
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/52039e5c19c950d4c7d6ec5da42ebba2c6def7ee || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/3630f1ffcec0e075bf446b88c7b507b1287b571d || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0 || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/3e8971c6c5f16674958913a94a36b1ea7a00ac46 || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/3e8971c6c5f16674958913a94a36b1ea7a00ac46 || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/2123756e0b1fc8243547235a33c0fcabfe3b9a51 || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/a4c60b3fefda228cd7439d3565df043192fef137 || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/a4c60b3fefda228cd7439d3565df043192fef137 || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/7d9831e05094ce723947d729c2a46a09d6e90275 || :
cp %{_builddir}/keditbookmarks-%{version}/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/keditbookmarks/7d9831e05094ce723947d729c2a46a09d6e90275 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/keditbookmarks/2123756e0b1fc8243547235a33c0fcabfe3b9a51
/usr/share/package-licenses/keditbookmarks/29fb05b49e12a380545499938c4879440bd8851e
/usr/share/package-licenses/keditbookmarks/3630f1ffcec0e075bf446b88c7b507b1287b571d
/usr/share/package-licenses/keditbookmarks/3e8971c6c5f16674958913a94a36b1ea7a00ac46
/usr/share/package-licenses/keditbookmarks/52039e5c19c950d4c7d6ec5da42ebba2c6def7ee
/usr/share/package-licenses/keditbookmarks/7c203dee3a03037da436df03c4b25b659c073976
/usr/share/package-licenses/keditbookmarks/7d9831e05094ce723947d729c2a46a09d6e90275
/usr/share/package-licenses/keditbookmarks/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
/usr/share/package-licenses/keditbookmarks/a4c60b3fefda228cd7439d3565df043192fef137
...
/usr/share/man/sl/man1/kbookmarkmerger.1
