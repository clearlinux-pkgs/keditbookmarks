...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/keditbookmarks-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/keditbookmarks-22.12.0.tar.xz.sig
...
%prep
%setup -q -n keditbookmarks-22.12.0
cd %{_builddir}/keditbookmarks-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670540024
mkdir -p clr-build
pushd clr-build
