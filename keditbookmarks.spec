...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/keditbookmarks-21.12.0.tar.xz
...
%prep
%setup -q -n keditbookmarks-21.12.0
cd %{_builddir}/keditbookmarks-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639637162
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/keditbookmarks-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/keditbookmarks/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/keditbookmarks-21.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/keditbookmarks/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
